---
name: memory-index
description: Index of client-reactjs agent memory — current repository state and the task records to load before resuming work.
---

# Memory Index — client-reactjs
